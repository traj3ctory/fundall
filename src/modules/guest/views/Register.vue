<template>
  <main class="register container-lg container-fluid">
    <div class="row">
      <div class="col-md-5 col-12 d-md-block d-none mb-3 img_container">
        ...
        />
        <h4>
          <span class="text_fundall">Welcome!</span>&ensp;Let's get<br />to know
          you.
        </h4>
        <p>
          Your first step toward a better financial<br />lifestyle starts here.
        </p>
      </div>
